...
const PostTwo = ({ data, setData }) => {
  ...
  // const [flatsType, setFlatsType] = useState("");
  // const [showFlatsOptions, setShowFlatsOptions] = useState(false);
  ...
  //   }
  // };
  // const handleFlatsType = (type) => {
  //   if (type === "Flats") {
  //     setShowFlatsOptions(!showFlatsOptions);
  //   } else {
  //     setFlatType(type);
  //     setShowFlatsOptions(type === "Flats");
  //   }
  // };
                  ...
                  {showCommercialOptions && (
                    <div className="residential_property">
                      ...
                      <div className="two_main_btns flex items-center gap-4">
                        ...
                        <div className="two_main_btns_one">
                          <button onClick={() => handleFlatType("Flats")}>
                            Industrial Building
                          </button>
                        </div>
                      </div>
            ...
            <div className="cancel_btn_two_three">
              ...
              <div className="cancel_text_main">
                <div className="cancel_text_one">
                  ...
                  <div className="two_main_btns ">
                    <div
                      className="two_main_btns_one flex items-center"
                      id="twomainbtnone"
                    >
                      <button>1 BHK</button>
                      <button>2 BHK</button>
